    ...
    return (
        <div className="w-11/12 mx-auto border-t-2 pt-4 mt-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 mb-12 gap-4 text-center">
                <div>
                    <div>
                        <img style={{height:"150px"}} className="mx-auto rounded-lg" src={qualified} alt="" />
                    </div>
                ...
                <div>
                    <div>
                        <img style={{height:"150px"}} className="mx-auto rounded-lg" src={transparent} alt="" />
                    </div>
                    <div className="flex flex-col md:flex-row items-center justify-center mt-2">
                        <i className="fas fa-caret-right mr-4 text-2xl text-blue-900"></i>
                ...
                <div>
                    <div>
                        <img style={{height:"150px"}} className="mx-auto rounded-lg" src={emergency} alt="" />
                    </div>
                    <div className="flex flex-col md:flex-row items-center justify-center mt-2">
                        <i className="fas fa-caret-right mr-4 text-2xl text-blue-900"></i>
                ...
                <div>
                    <div>
                        <img style={{height:"150px"}} className="mx-auto rounded-lg" src={time} alt="" />
                    </div>
                    <div className="flex flex-col md:flex-row items-center justify-center mt-2">
                        <i className="fas fa-caret-right mr-4 text-2xl text-blue-900"></i>
